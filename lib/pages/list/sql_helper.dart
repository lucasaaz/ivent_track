...
class SQLHelper {
  ...
  static Future<int> adicionarProduto(
      String nome, String descricao, int status, int qrcode, int qte) async {
  ...
  static Future<int> atualizaProduto(int id, String nome, String descricao,
      int status, int qrcode, int qte) async {
    final db = await SQLHelper.db();
