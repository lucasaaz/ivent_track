...
class _ListWidgetState extends State<ListWidget> {
  ...
  void _mostraEdicao(int? id) async {
    if (id != null) {
      ...
      _statusController.text = produtoExistente['status'];
                ...
                SwitcherButton(
                  ...
                  onChange: (value) {
                    ...
                    if (value) {
                      ...
                      sta = 0;
                    } // O valor já é um bool, não precisa converter para int

                    _statusController.text = sta.toString();

                    // Se `alterarStatus` é uma função que você quer chamar, faça isso aqui.
                    alterarStatus();

                    // Use `print` para verificar o valor do sta.
                    print(sta);
                  },
                ),
              ],
